...
var RestauranteService = (function () {
    ...
    RestauranteService.prototype.addRestaurante = function (restaurante) {
        ...
        return this._http.post(this.url, body, { headers: headers }).map(function (res) { return res.json(); });
    };
    RestauranteService.prototype.editRestaurante = function (id, restaurante) {
        console.log(restaurante);
        var body = JSON.stringify(restaurante);
        var headers = new http_1.Headers({ "Content-Type": "application/json" });
        return this._http.put(this.url, body, { headers: headers }).map(function (res) { return res.json(); });
    };
